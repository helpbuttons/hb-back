...
export class TemplateButtonRepository extends DefaultCrudRepository<
  ...
  TemplateButtonRelations
> {
  public readonly buttons: HasManyRepositoryFactory<
    Button,
    typeof TemplateButton.prototype.id
  >;
  public readonly networks: HasManyThroughRepositoryFactory<
    Network,
  ...
  constructor(
    ...
    this.buttons = this.createHasManyRepositoryFactoryFor(
      'buttons',
      buttonRepositoryGetter,
    );
    this.registerInclusionResolver('buttons', this.buttons.inclusionResolver);

    this.networks = this.createHasManyThroughRepositoryFactoryFor(
      'networks',
