...
export class init1659455183105 implements MigrationInterface {
    name = 'init1659455183105'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "template_button" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "slug" character varying NOT NULL, "description" character varying NOT NULL, "formFields" character varying NOT NULL, "networkId" character varying, CONSTRAINT "PK_36c586235297741bc8e8d22ccea" PRIMARY KEY ("slug"))`);
